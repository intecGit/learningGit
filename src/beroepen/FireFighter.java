...
public class FireFighter extends Person {
    ...
    public FireFighter(String name,Job job) {
        super(name);
        this.job = job;
    }

    public FireFighter(String name, int age, Job job) {
        super(name, age);
        this.job = job;
    }

    public FireFighter(String name, int age, double height, Job job) {
    ...
    public String toString() {
        return super.toString()+" FireFighter " +
                "job " + job;
    }
}
