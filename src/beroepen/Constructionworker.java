...
public class Constructionworker extends Person {
    ...
    public Constructionworker(String name,Job job) {
        super(name);
        this.job = job;
    }

    public Constructionworker(String name, int age, Job job) {
        super(name, age);
        this.job = job;
    }

    public Constructionworker(String name, int age, double height, Job job) {
    ...
    public String toString() {
        return super.toString()+" Constructionworker " +
                "job " + job;
    }
}
