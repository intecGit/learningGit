...
public class Jobless extends Person {
    ...
    public Jobless(String name,Job job) {
        super(name);
        this.job = job;
    }

    public Jobless(String name, int age, Job job) {
        super(name, age);
        this.job = job;
    }

    public Jobless(String name, int age, double height, Job job) {
